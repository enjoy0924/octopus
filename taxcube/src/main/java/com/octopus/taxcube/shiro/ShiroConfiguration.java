...
//        factoryBean.setSuccessUrl("/home");
        ...
        filterRuleMap.put("/api/export/**", "anon");
        filterRuleMap.put("/api/wechat/auth","anon");
        filterRuleMap.put("/api/product/catalogs", "anon");
        filterRuleMap.put("/api/product/*/tasks","anon");
        filterRuleMap.put("/api/products","anon");
...
//        filterRuleMap.put("/*", "authc");
    ...
    @Bean(name = "redisShiroCacheManager1")
