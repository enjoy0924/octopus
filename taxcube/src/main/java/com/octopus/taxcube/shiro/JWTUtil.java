...
import com.octopus.taxcube.util.PropertiesUtil;
...
public class JWTUtil {
    ...
    private final static String ISSUER = "Taxcube";
//    public final static String SECRET = "token";
     ...
     * @return 加密的token
     */
    public static String sign(Long userId, String username, String secret, String roleType) {
        try {
